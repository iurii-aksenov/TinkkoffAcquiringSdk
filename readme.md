...
https://github.com/TinkoffCreditSystems/AcquiringSdkAndroid

# Not official Tinkoff Acquiring SDK for C#, Net 5.0.

(ENG is below)

It's a C# version that are bases on official SDK for Android  [TinkoffCreditSystems/AcquiringSdkAndroid(https://github.com/TinkoffCreditSystems/AcquiringSdkAndroid)]

На текуший момент данный SDK содержит только метод, позволяющий 
